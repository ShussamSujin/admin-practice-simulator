...
| 모드 | 계정 | 보이는 메뉴 |
|---|---|---|
| **센스쿨** (기본) | admin@practice.senedu.kr | 홈 · 디렉터리 · 기기 · 보안 · 데이터 · 규칙 — senedu.kr 학교 관리자에게 위임된 범위 |
| **최고관리자** | superadmin@practice.senedu.kr | 위 메뉴 + Chrome 브라우저 · 앱 · 생성형 AI · 에이전트 · 보고 · 결제 · 계정 · 저장용량 |
