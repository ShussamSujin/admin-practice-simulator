...
- 조직 단위 · 사용자 · 그룹 만들기/삭제 (연습 데이터)
- Chrome **사용자 및 브라우저 설정 / 기기 설정 / 관리 게스트 세션 설정** 정책 570여 개 — 항목을 눌러 값을 바꾸고 저장
- 앱 및 확장 프로그램, Workspace 서비스별 설정(Gmail, Meet, Classroom, Drive, Calendar …), 생성형 AI(Gemini) 설정
